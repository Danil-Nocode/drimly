...
class _$FilesRecord extends FilesRecord {
  ...
  _$FilesRecord._({this.name, this.type, this.file, this.audio, this.ffRef})
      : super._();
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc($jc($jc(0, name.hashCode), type.hashCode), file.hashCode),
            audio.hashCode),
        ffRef.hashCode));
  }
...
class FilesRecordBuilder implements Builder<FilesRecord, FilesRecordBuilder> {
  ...
  _$FilesRecord _build() {
    final _$result = _$v ??
        new _$FilesRecord._(
            name: name, type: type, file: file, audio: audio, ffRef: ffRef);
    replace(_$result);
    return _$result;
  }
}
